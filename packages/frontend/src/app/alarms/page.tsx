            ...
            <Card key={alarm.id} className={`!p-0 transition-opacity ${!alarm.enabled ? 'opacity-50' : ''}`}>
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2 px-3 sm:px-4 py-3">
                ...
                <div className="min-w-0">
                  <p className="text-2xl font-light tabular-nums whitespace-nowrap" style={{ color: alarm.enabled ? 'var(--color-text)' : 'var(--color-text-muted)' }}>
                ...
                <span className="sm:hidden text-xs ml-auto truncate max-w-[45%]" style={{ color: 'var(--color-text-muted)' }}>
