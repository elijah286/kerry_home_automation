...
import { TeslaCard } from './types/TeslaCard';
import { DoorWindowCard } from './types/DoorWindowCard';
import { BatteryCard } from './types/BatteryCard';
import { WeatherCard } from './types/WeatherCard';
...
function CardRendererInner({ card }: { card: CardDescriptor }) {
  switch (card.type) {
    ...
    case 'tesla':              return <TeslaCard card={card} />;
    case 'door-window':        return <DoorWindowCard card={card} />;
    case 'battery':            return <BatteryCard card={card} />;
